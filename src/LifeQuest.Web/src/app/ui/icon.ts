...
const ICONS = {
  ...
  cloud: { paths: ['M17.5 19a4.5 4.5 0 0 0 .5-8.97A6 6 0 0 0 6.34 9.5 4.75 4.75 0 0 0 6.75 19z'] },
  'cloud-rain': { paths: ['M16 13.5a4 4 0 0 0 .4-7.97A5.5 5.5 0 0 0 5.8 7.2 4.2 4.2 0 0 0 6.2 15.5', 'M8 17l-1 3', 'M12 17l-1 3', 'M16 17l-1 3'] },
  calendar: { paths: ['M3 9h18', 'M8 3v4', 'M16 3v4', 'M5 5h14a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2z'] },
